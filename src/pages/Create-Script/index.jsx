...
import watchStoryNode from '../../components/nodes/watchStory.jsx';
...
const CreateScript = () => {
  ...
  const [showWatchStoryContent, setShowWatchStoryContent] = useState(false);

  const handleSvgClick = () => {
    console.log('Clicked');
    setShowWatchStoryContent(true);
  };
  return (
    <>
      <div className="create-script">
        ...
        <div className="create-script__content">
          <watchStoryNode onSvgClick={handleSvgClick}></watchStoryNode>

          {showWatchStoryContent ? (
              ...
              <div className="left-content">
                ...
                <div className="left-content__container">
                  <div class="grid-container">
                    <div class="card" onDragStart={(event) => onDragStart(event, 'watchStory')} draggable>
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'watchVideo')} draggable>
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'newsFeed')} draggable>
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'createPost')} draggable>
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'postInteract')} draggable>
                      <svg xmlns="http://www.w3.org/2000/svg" width="37" height="26" viewBox="0 0 37 26" fill="none">
                        <path
                          d="M21 25H4.63636C2.63636 25 1 23.3636 1 21.3636V8.63636C1 6.63636 2.63636 5 4.63636 5H21C23 5 24.6364 6.63636 24.6364 8.63636V21.3636C24.6364 23.3636 23 25 21 25Z"
                          stroke="#01162B"
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'deletePost')} draggable>
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'viewNoti')} draggable>
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'sendMsg')} draggable>
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                        <path
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'replyMsg')} draggable>
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                        <path
                          d="M18.0711 3.92895C14.1658 0.0236849 7.83419 0.0236849 3.92893 3.92895C0.548669 7.30921 0.0942105 12.5074 2.56583 16.3765L1.97988 19.3862C1.90664 19.7624 2.23758 20.0934 2.6138 20.0201L5.62352 19.4342C9.49256 21.9058 14.6908 21.4513 18.0711 18.0711C21.9763 14.1658 21.9763 7.83421 18.0711 3.92895Z"
                          stroke="#01162B"
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'addFriend')} draggable>
                    ...
                    <div class="card" onDragStart={(event) => onDragStart(event, 'cancelFriend')} draggable>
