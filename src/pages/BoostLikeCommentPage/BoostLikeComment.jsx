...
import SeedingLikeComment from '../../components/SeedingLikeComment/SeedingLikeComment'
import './style.scss'

const BoostLikeComment = () => {
  ...
  return (
    <div className="layout-boost">
      <div className="-container-boost">
        ...
        <SeedingLikeComment></SeedingLikeComment>
      </div>
    </div>
  )
}

export default BoostLikeComment