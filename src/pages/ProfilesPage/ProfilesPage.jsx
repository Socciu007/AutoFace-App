          ...
          <div className="-wrapper-option-profiles">
            ...
            <span className="-option-profiles">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <circle cx="9" cy="9" r="8.25" stroke="#01162B" strokeWidth="1.5"/>
                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                  <path d="M2.78599 2.07227L0.857422 4.00084L2.78599 5.92941" stroke="#01162B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M9.21401 2.07227L11.1426 4.00084L9.21401 5.92941" stroke="#01162B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M7.28627 0.786133L4.71484 7.85756" stroke="#01162B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </svg>
            </span>
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.0532 7.77817C15.0532 7.10845 14.5103 6.56553 13.8406 6.56553L8.98999 6.56553L8.98999 1.71494C8.98999 1.04522 8.44707 0.502296 7.77734 0.502296C7.10762 0.502296 6.5647 1.04522 6.5647 1.71494L6.5647 6.56553L1.71411 6.56553C1.04439 6.56553 0.501467 7.10845 0.501467 7.77817C0.501468 8.4479 1.04439 8.99082 1.71411 8.99082L6.5647 8.99082V13.8414C6.5647 14.5111 7.10762 15.0541 7.77734 15.0541C8.44707 15.0541 8.98999 14.5111 8.98999 13.8414V8.99082L13.8406 8.99082C14.5103 8.99082 15.0532 8.4479 15.0532 7.77817Z" fill="#01162B"/>
              </svg>
            </span>
          </div>
        </div>
        <div className="-wrapper-btn-profiles">
          <button>Run</button>
        </div>
      </div>
