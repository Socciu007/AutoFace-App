...
const WatchVideo = () => {
  ...
  const placeholders = ['1 Enter the content here', '2 Each content/line'];
  ...
  const handleChange = (event) => {
    ...
    lines.forEach((line, index) => {
      if (line.trim() === '') {
        lines[index] = placeholders[index] || '';
      }
    });
    ...
    <div className="watch-video">
      ...
      <div className="scrollable-container">
        <div className="componet-left">
          ...
          <div className="text">
            {/* <input type="text" name="textContent" className="textContent" id="textContent" /> */}
            <textarea id="textContent" name="textContent" rows="10" value={text} onChange={handleChange}></textarea>
          </div>
          <p className="selectComment__header">Photo/video</p>
          <div className="photoOrVideo">
            <table cellSpacing={'12px 0'}>
              ...
              <tbody>
                <tr className="numberOfVideo">
                  <td className="componet-left__header">
                    <p className="numberOfVideo__photo">Number of photo/video:</p>
                  </td>
                  <td className="componet-left__number">
                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
                      <path
          ...
          <div className="dragVideoOrPhoto">
