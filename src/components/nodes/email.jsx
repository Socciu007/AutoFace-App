...
import createPostLeft from '../../assets/icon/icon-newsfeedLeft.svg';
import passIcon from '../../assets/icon/icon-email-node.svg';
import optionNode from '../../assets/icon/icon-optionNode.svg';
import Menu from '@mui/material/Menu';
import MenuItem from '@mui/material/MenuItem';

function emailNode({ data: { label, onButtonClick, onDeleteNode }, isConnectable, id }) {
