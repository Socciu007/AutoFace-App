...
import createPostLeft from '../../assets/icon/icon-replyLeft.svg';
import passIcon from '../../assets/icon/icon-infor-node.svg';
import optionNode from '../../assets/icon/icon-optionNode.svg';
import Menu from '@mui/material/Menu';
import MenuItem from '@mui/material/MenuItem';

function informationNode({ data: { label, onButtonClick, onDeleteNode }, isConnectable, id }) {
