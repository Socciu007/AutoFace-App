...
import createPostLeft from '../../assets/icon/loginLeft.svg';
import createPostIcon from '../../assets/icon/loginIcon.svg';
...
function loginNode({ data: { label, onButtonClick, onDeleteNode }, isConnectable, id }) {
