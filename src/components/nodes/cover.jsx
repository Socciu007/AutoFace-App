...
import createPostLeft from '../../assets/icon/icon-addFriendLeft.svg';
import passIcon from '../../assets/icon/icon-cover-node.svg';
import optionNode from '../../assets/icon/icon-optionNode.svg';
import Menu from '@mui/material/Menu';
import MenuItem from '@mui/material/MenuItem';

function coverNode({ data: { label, onButtonClick, onDeleteNode }, isConnectable, id }) {
