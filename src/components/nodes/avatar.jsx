...
import createPostLeft from '../../assets/icon/icon-sendMsgLeft.svg';
import passIcon from '../../assets/icon/icon-avatar-node.svg';
import optionNode from '../../assets/icon/icon-optionNode.svg';
import Menu from '@mui/material/Menu';
import MenuItem from '@mui/material/MenuItem';

function avatarNode({ data: { label, onButtonClick, onDeleteNode }, isConnectable, id }) {
