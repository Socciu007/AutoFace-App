...
const CreatePostGroup = ({ onGoBackClick, id, currentSetup, component }) => {
  const initialValues = {
    postStart: 1,
    postEnd: 2,
    delayTimeStart: 5,
  ...
  const handleDivUIDListClick = () => {
    document.getElementById('UIDGroup').focus();
  };
              ...
              <div className="PostContent">
                ...
                <div className="UIDList">
                  ...
                  <div className="component-item" style={{ position: 'relative' }}>
                    ...
                    <div
                      onClick={handleDivUIDListClick}
                      className={`placeholder ${values.UIDGroupContent ? 'hide' : ''}`}
                    >
                      <p>
